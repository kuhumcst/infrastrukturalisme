...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21868__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21868__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21868__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__5733__auto___21964 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___21964)){
var seen_errors_21965 = temp__5733__auto___21964;
if(cljs.core.truth_(seen_errors_21965.has(self))){
} else {
seen_errors_21965.add(self);

var temp__5735__auto___21966 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___21966)){
var sense_21967 = temp__5735__auto___21966;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_21967)].join(''));
} else {
}
}
} else {
