...
var G__20351 = o;
goog.object.set(G__20351,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__20512__delegate = function (args){
...
while (G__20513__i < G__20513__a.length) {G__20513__a[G__20513__i] = arguments[G__20513__i + 0]; ++G__20513__i;}
  args = new cljs.core.IndexedSeq(G__20513__a,0,null);
} 
return G__20512__delegate.call(this,args);};
G__20512.cljs$lang$maxFixedArity = 0;
G__20512.cljs$lang$applyTo = (function (arglist__20514){
var args = cljs.core.seq(arglist__20514);
...
var G__20368 = o;
goog.object.set(G__20368,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__20574__i < G__20574__a.length) {G__20574__a[G__20574__i] = arguments[G__20574__i + 0]; ++G__20574__i;}
  args = new cljs.core.IndexedSeq(G__20574__a,0,null);
} 
...
var G__20378 = props;
var G__20378__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20378,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__20378);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20378__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__20388 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20388,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__20388;
}
})(),id_class);
...
var G__20400 = (cljs.core.count(argv) - first_child);
switch (G__20400) {
case (0):
...
var vec__20424 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20424,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20424,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20424,(2),null);
...
var temp__5739__auto___20608 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___20608 == null)){
} else {
var key_20609 = temp__5739__auto___20608;
(jsprops.key = key_20609);
}
...
var temp__5739__auto___20610 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___20610 == null)){
} else {
var key_20611 = temp__5739__auto___20610;
(jsprops.key = key_20611);
}
...
var temp__5739__auto___20614 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___20614 == null)){
} else {
var key_20615 = temp__5739__auto___20614;
(jsprops.key = key_20615);
}
...
var temp__5739__auto___20621 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___20621 == null)){
} else {
var key_20622 = temp__5739__auto___20621;
(jsprops.key = key_20622);
}
...
var temp__5739__auto___20624 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___20624 == null)){
} else {
var key_20625 = temp__5739__auto___20624;
(jsprops.key = key_20625);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20453_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__20453_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__20454 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20454,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20454,(1),null);
...
break;
default:
var G__20633 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__20634 = compiler;
v = G__20633;
compiler = G__20634;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template20472 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template20472 = (function (opts,id,fn_to_element,meta20473){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template20472.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20474,meta20473__$1){
var self__ = this;
var _20474__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template20472(self__.opts,self__.id,self__.fn_to_element,meta20473__$1));
}));

(reagent.impl.template.t_reagent$impl$template20472.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20474){
var self__ = this;
var _20474__$1 = this;
return self__.meta20473;
}));

(reagent.impl.template.t_reagent$impl$template20472.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template20472.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template20472.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template20472.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template20472.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta20473","meta20473",-568308999,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template20472.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template20472.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template20472");

(reagent.impl.template.t_reagent$impl$template20472.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template20472");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template20472.
 */
reagent.impl.template.__GT_t_reagent$impl$template20472 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template20472(opts__$1,id__$1,fn_to_element__$1,meta20473){
return (new reagent.impl.template.t_reagent$impl$template20472(opts__$1,id__$1,fn_to_element__$1,meta20473));
});

}

return (new reagent.impl.template.t_reagent$impl$template20472(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
