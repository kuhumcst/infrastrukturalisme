...
var o21999 = temp__5733__auto__;
var temp__5733__auto____$1 = (o21999["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o22000 = temp__5733__auto____$1;
return (o22000["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21562__auto__ = f;
return (o__21562__auto__["toString"]).call(o__21562__auto__);
} else {
return "";
}
}catch (e22005){var _ = e22005;
return "";
}});
...
try{var o__21562__auto___22213 = t;
(o__21562__auto___22213["cljs$lang$ctorPrWriter"]).call(o__21562__auto___22213,t,writer);
}catch (e22009){var __22214 = e22009;
}
...
var char_code = (function (){var o__21562__auto__ = (new String(char$));
return (o__21562__auto__["charCodeAt"]).call(o__21562__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21562__auto__ = String;
return (o__21562__auto__["fromCharCode"]).call(o__21562__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22011 = num_code;
switch (G__22011) {
case (1):
return (185);
...
var o__21562__auto__ = String;
return (o__21562__auto__["fromCharCode"]).call(o__21562__auto__,superscript_code);
});
/**
...
}catch (e22014){var _e__21577__auto__ = e22014;
return false;
}})())){
...
var vec__22019 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22019,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22032){
var vec__22033 = p__22032;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22033,(0),null);
...
var G__22247 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__22248 = cljs.core.butlast(remaining_tokens);
name_tokens = G__22247;
remaining_tokens = G__22248;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22030){
var G__22031 = cljs.core.first(seq22030);
var seq22030__$1 = cljs.core.next(seq22030);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22031,seq22030__$1);
}));
...
var vec__22048 = cljs.core.split_with((function (p1__22047_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__22047_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22048,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22048,(1),null);
...
var vec__22054 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22054,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22054,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__22257 = cljs.core.rest(remaining_tokens);
var G__22258 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__22257;
name_tokens = G__22258;
continue;
} else {
...
var vec__22060 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22060,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22060,(1),null);
var vec__22063 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22063,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22063,(1),null);
var vec__22066 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22066,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22066,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22066,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22066,(3),null);
...
var vec__22075 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22075,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22075,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22075,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22075,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22075,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22075,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__22079 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22079,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22079,(1),null);
var vec__22082 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22082,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22082,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__22086 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__22086) : devtools.munging.parse_fn_info_deep.call(null,G__22086));
})()));
}
} else {
return fn_info;
...
var G__22305 = (arity + (1));
var G__22306 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22098){
var vec__22099 = p__22098;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22099,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22099,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22102_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__22102_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22103_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__22103_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___22327 = arguments.length;
var i__4737__auto___22330 = (0);
while(true){
if((i__4737__auto___22330 < len__4736__auto___22327)){
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22109){
var vec__22110 = p__22109;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22110,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22107){
var G__22108 = cljs.core.first(seq22107);
var seq22107__$1 = cljs.core.next(seq22107);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22108,seq22107__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22166__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22166__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22166__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22166__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22167 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22167,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22167,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22167,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22167,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22167,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22167,(5),null);
...
var o__21562__auto__ = f;
return (o__21562__auto__["getBasis"]).call(o__21562__auto__);
});
/**
...
}catch (e22179){var _e__21577__auto__ = e22179;
...
var G__22347 = (obj[cljs.core.first(path)]);
var G__22348 = cljs.core.rest(path);
obj = G__22347;
path = G__22348;
continue;
} else {
...
var _STAR_ = (function (accum,p__22193){
var vec__22194 = p__22193;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22194,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22194,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22197){
var vec__22198 = p__22197;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22198,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22198,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22198,(2),null);
...
var post_process = (function (p__22208){
var vec__22209 = p__22208;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22209,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22209,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22205_SHARP_){
return (obj[cljs.core.first(p1__22205_SHARP_)]);
}),sorted_matches);
