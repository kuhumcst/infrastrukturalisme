...
"\\u2028").replace("\u2029","\\u2029"):x}const get1=field=>function(obj){return obj[field]},getN=path=>{const len=path.length;return function(obj){for(let i=0;i<len;++i)obj=obj[path[i]];return obj}},id=field("id"),identity=accessor(_=>_,[],"identity"),zero=accessor(()=>0,[],"zero"),one=accessor(()=>1,[],"one"),truthy=accessor(()=>!0,[],"true"),falsy=accessor(()=>!1,[],"false");var isArray=Array.isArray;const exp=sign=>x=>sign*Math.exp(x),log$1=sign=>x=>Math.log(sign*x),symlog=c=>x=>Math.sign(x)*Math.log1p(Math.abs(x/
...
b=peek(range);b<a&&(range=a,a=b,b=range);range=Math.abs(value-a);value=Math.abs(b-value);return range<value&&range<=threshold?left:value<=threshold?right:center};exports.hasOwnProperty=has;exports.id=id;exports.identity=identity;exports.inherits=function(child,parent,members){parent=child.prototype=Object.create(parent.prototype);parent.constructor=child;return extend(parent,members)};exports.inrange=function(value,range,left,right){let r0=range[0];range=range[range.length-1];let t;r0>range&&(t=r0,
r0=range,range=t);return(void 0===left||left?r0<=value:r0<value)&&(void 0===right||right?value<=range:value<range)};exports.isArray=isArray;exports.isBoolean=function(_){return"boolean"===typeof _};exports.isDate=isDate;exports.isFunction=isFunction;exports.isNumber=isNumber;exports.isObject=isObject;exports.isRegExp=function(_){return"[object RegExp]"===Object.prototype.toString.call(_)};exports.isString=isString;exports.key=function(fields,flat,opt){fields&&(fields=flat?array$jscomp$0(fields).map(f=>
f.replace(/\\(.)/g,"$1")):array$jscomp$0(fields));const len=fields&&fields.length,gen=opt&&opt.get||getter;opt=f=>gen(flat?[f]:splitAccessPath(f));if(len)if(1===len){const get=opt(fields[0]);opt=function(_){return""+get(_)}}else{const get=fields.map(opt);opt=function(_){let s=""+get[0](_),i=0;for(;++i<len;)s+="|"+get[i](_);return s}}else opt=function(){return""};return accessor(opt,fields,"key")};exports.lerp=function(array,frac){const lo=array[0];array=peek(array);return(frac=+frac)?1===frac?array:
lo+frac*(array-lo):lo};exports.logger=function(_$jscomp$0,method){let level=_$jscomp$0||0;return{level(_){return arguments.length?(level=+_,this):level},error(){1<=level&&log(method||"error","ERROR",arguments);return this},warn(){2<=level&&log(method||"warn","WARN",arguments);return this},info(){3<=level&&log(method||"log","INFO",arguments);return this},debug(){4<=level&&log(method||"log","DEBUG",arguments);return this}}};exports.lruCache=function(maxsize){maxsize=+maxsize||1E4;let curr,prev,size;
const clear=()=>{curr={};prev={};size=0},update=(key,value)=>{++size>maxsize&&(prev=curr,curr={},size=1);return curr[key]=value};clear();return{clear,has:key=>has(curr,key)||has(prev,key),get:key=>has(curr,key)?curr[key]:has(prev,key)?update(key,prev[key]):void 0,set:(key,value)=>has(curr,key)?curr[key]=value:update(key,value)}};exports.merge=function(compare,array0,array1,output){const n0=array0.length,n1=array1.length;if(!n1)return array0;if(!n0)return array1;output=output||new array0.constructor(n0+
n1);let i0=0,i1=0,i=0;for(;i0<n0&&i1<n1;++i)output[i]=0<compare(array0[i0],array1[i1])?array1[i1++]:array0[i0++];for(;i0<n0;++i0,++i)output[i]=array0[i0];for(;i1<n1;++i1,++i)output[i]=array1[i1];return output};exports.mergeConfig=function(...configs){return configs.reduce((out,source)=>{for(const key in source)"signals"===key?out.signals=mergeNamed(out.signals,source.signals):writeConfig(out,key,source[key],"legend"===key?{layout:1}:"style"===key?!0:null);return out},{})};exports.one=one;exports.pad=
function(str,length,padchar,align){padchar=padchar||" ";str+="";length-=str.length;return 0>=length?str:"left"===align?repeat(padchar,length)+str:"center"===align?repeat(padchar,~~(length/2))+str+repeat(padchar,Math.ceil(length/2)):str+repeat(padchar,length)};exports.panLinear=function(domain,delta){return pan(domain,delta,toNumber,identity)};exports.panLog=function(domain,delta){var sign=Math.sign(domain[0]);return pan(domain,delta,log$1(sign),exp(sign))};exports.panPow=function(domain,delta,exponent){return pan(domain,
delta,pow(exponent),pow(1/exponent))};exports.panSymlog=function(domain,delta,constant){return pan(domain,delta,symlog(constant),symexp(constant))};exports.peek=peek;exports.quarter=function(date){return 1+~~((new Date(date)).getMonth()/3)};exports.repeat=repeat;exports.span=function(array){return array&&peek(array)-array[0]||0};exports.splitAccessPath=splitAccessPath;exports.stringValue=$;exports.toBoolean=function(_){return null==_||""===_?null:_&&"false"!==_&&"0"!==_?!!_:!1};exports.toDate=function(_,
parser){parser=parser||defaultParser;return null==_||""===_?null:parser(_)};exports.toNumber=toNumber;exports.toSet=function(_){const s={},n=_.length;for(let i=0;i<n;++i)s[_[i]]=!0;return s};exports.toString=function(_){return null==_||""===_?null:_+""};exports.truncate=function(str,length,align,ellipsis){ellipsis=null!=ellipsis?ellipsis:"…";str+="";const n=str.length,l=Math.max(0,length-ellipsis.length);return n<=length?str:"left"===align?ellipsis+str.slice(n-l):"center"===align?str.slice(0,Math.ceil(l/
2))+ellipsis+str.slice(n-~~(l/2)):str.slice(0,l)+ellipsis};exports.truthy=truthy;exports.utcquarter=function(date){return 1+~~((new Date(date)).getUTCMonth()/3)};exports.visitArray=function(array,filter,visitor){if(array)if(filter){const n=array.length;for(let i=0;i<n;++i){const t=filter(array[i]);t&&visitor(t,i,array)}}else array.forEach(visitor)};exports.writeConfig=writeConfig;exports.zero=zero;exports.zoomLinear=function(domain,anchor,scale){return zoom(domain,anchor,scale,toNumber,identity)};
exports.zoomLog=function(domain,anchor,scale){const sign=Math.sign(domain[0]);return zoom(domain,anchor,scale,log$1(sign),exp(sign))};exports.zoomPow=function(domain,anchor,scale,exponent){return zoom(domain,anchor,scale,pow(exponent),pow(1/exponent))};exports.zoomSymlog=function(domain,anchor,scale,constant){return zoom(domain,anchor,scale,symlog(constant),symexp(constant))};Object.defineProperty(exports,"__esModule",{value:!0})})}
