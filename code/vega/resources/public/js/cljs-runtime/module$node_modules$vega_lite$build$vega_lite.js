...
lex();var JSCompiler_object_inline_value_4105=new ASTNode("ArrayExpression");JSCompiler_object_inline_value_4105.elements=type;return type=JSCompiler_object_inline_value_4105}if(match("{")){type=[];JSCompiler_object_inline_value_4105={};var JSCompiler_object_inline_literal_4106=String;index$jscomp$0=lookahead.start;for(expect("{");!match("}");){index$jscomp$0=lookahead.start;var JSCompiler_object_inline_value_4107=lookahead;if(3===JSCompiler_object_inline_value_4107.type){var JSCompiler_object_inline_literal_4108=
parseObjectPropertyKey();expect(":");JSCompiler_object_inline_value_4107=parseConditionalExpression();JSCompiler_object_inline_value_4107=finishProperty("init",JSCompiler_object_inline_literal_4108,JSCompiler_object_inline_value_4107)}else 2===JSCompiler_object_inline_value_4107.type||7===JSCompiler_object_inline_value_4107.type?(throwUnexpected(JSCompiler_object_inline_value_4107),JSCompiler_object_inline_value_4107=void 0):(JSCompiler_object_inline_literal_4108=parseObjectPropertyKey(),expect(":"),
JSCompiler_object_inline_value_4107=parseConditionalExpression(),JSCompiler_object_inline_value_4107=finishProperty("init",JSCompiler_object_inline_literal_4108,JSCompiler_object_inline_value_4107));JSCompiler_object_inline_literal_4108="Identifier"===JSCompiler_object_inline_value_4107.key.type?JSCompiler_object_inline_value_4107.key.name:JSCompiler_object_inline_literal_4106(JSCompiler_object_inline_value_4107.key.value);JSCompiler_object_inline_literal_4108="$"+JSCompiler_object_inline_literal_4108;
Object.prototype.hasOwnProperty.call(JSCompiler_object_inline_value_4105,JSCompiler_object_inline_literal_4108)?throwError({},"Duplicate data property in object literal not allowed in strict mode"):JSCompiler_object_inline_value_4105[JSCompiler_object_inline_literal_4108]=!0;type.push(JSCompiler_object_inline_value_4107);match("}")||expect(",")}expect("}");JSCompiler_object_inline_value_4105=new ASTNode("ObjectExpression");JSCompiler_object_inline_value_4105.properties=type;return type=JSCompiler_object_inline_value_4105}type=
lookahead.type;index$jscomp$0=lookahead.start;if(3===type||legalKeywords[lookahead.value])JSCompiler_object_inline_value_4105=finishIdentifier(lex().value);else if(8===type||6===type)lookahead.octal&&throwError(lookahead,"Octal literals are not allowed in strict mode."),JSCompiler_object_inline_value_4105=finishLiteral(lex());else{if(4===type)throw Error("Disabled.");if(1===type)type=lex(),type.value="true"===type.value,JSCompiler_object_inline_value_4105=finishLiteral(type);else if(5===type)type=
lex(),type.value=null,JSCompiler_object_inline_value_4105=finishLiteral(type);else if(match("/")||match("/\x3d")){var value;lookahead=null;skipComment();type=index$jscomp$0;JSCompiler_object_inline_value_4105=source$jscomp$0[index$jscomp$0];assert("/"===JSCompiler_object_inline_value_4105,"Regular expression literal must start with a slash");JSCompiler_object_inline_literal_4106=source$jscomp$0[index$jscomp$0++];for(JSCompiler_object_inline_literal_4108=JSCompiler_object_inline_value_4107=!1;index$jscomp$0<
length$jscomp$0;)if(JSCompiler_object_inline_value_4105=source$jscomp$0[index$jscomp$0++],JSCompiler_object_inline_literal_4106+=JSCompiler_object_inline_value_4105,"\\"===JSCompiler_object_inline_value_4105)JSCompiler_object_inline_value_4105=source$jscomp$0[index$jscomp$0++],isLineTerminator(JSCompiler_object_inline_value_4105.charCodeAt(0))&&throwError({},"Invalid regular expression: missing /"),JSCompiler_object_inline_literal_4106+=JSCompiler_object_inline_value_4105;else if(isLineTerminator(JSCompiler_object_inline_value_4105.charCodeAt(0)))throwError({},
"Invalid regular expression: missing /");else if(JSCompiler_object_inline_value_4107)"]"===JSCompiler_object_inline_value_4105&&(JSCompiler_object_inline_value_4107=!1);else if("/"===JSCompiler_object_inline_value_4105){JSCompiler_object_inline_literal_4108=!0;break}else"["===JSCompiler_object_inline_value_4105&&(JSCompiler_object_inline_value_4107=!0);JSCompiler_object_inline_literal_4108||throwError({},"Invalid regular expression: missing /");JSCompiler_object_inline_value_4105=JSCompiler_object_inline_literal_4106.substr(1,
JSCompiler_object_inline_literal_4106.length-2);for(value=JSCompiler_object_inline_literal_4108="";index$jscomp$0<length$jscomp$0;){JSCompiler_object_inline_value_4107=source$jscomp$0[index$jscomp$0];if(!isIdentifierPart(JSCompiler_object_inline_value_4107.charCodeAt(0)))break;++index$jscomp$0;"\\"===JSCompiler_object_inline_value_4107&&index$jscomp$0<length$jscomp$0?throwError({},"Unexpected token %0","ILLEGAL"):(value+=JSCompiler_object_inline_value_4107,JSCompiler_object_inline_literal_4108+=JSCompiler_object_inline_value_4107)}0<=
value.search(/[^gimuy]/g)&&throwError({},"Invalid regular expression",value);JSCompiler_object_inline_value_4107=value;value=testRegExp(JSCompiler_object_inline_value_4105,JSCompiler_object_inline_value_4107);JSCompiler_object_inline_value_4105=finishLiteral({literal:JSCompiler_object_inline_literal_4106+JSCompiler_object_inline_literal_4108,value,regex:{pattern:JSCompiler_object_inline_value_4105,flags:JSCompiler_object_inline_value_4107},start:type,end:index$jscomp$0});peek()}else throwUnexpected(lex())}return JSCompiler_object_inline_value_4105}
